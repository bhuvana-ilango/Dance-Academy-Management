...
class Database:
    ...
    def editInstructor(self, insID, name, gender, dStyles, telNo, hrRate, avail, days, username, password):
        ...
        self.cur.execute(sql_insert_query,(name, gender, dStyles, telNo, hrRate, avail, days, username, password, insID))
        self.con.commit()
    ...
    def insertStudent(self, firstName, surName, email, dob, gender, telNo, address):
        self.cur.execute("INSERT INTO students VALUES (NULL,?,?,?,?,?,?,?)", (firstName, surName, email, dob, gender, telNo, address))
        self.con.commit()
