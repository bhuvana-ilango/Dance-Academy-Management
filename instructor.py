...
class InstructorControls:
    ...
    def instructorControlsFrame(self):
        ...
        # Student Last Name
        self.labelSName = Label(self.entriesFrame, text="Surname", font=("Times New Roman", 16, "bold"),  bg="#434242",
                                fg="#22a39f")
        ...
        # Student Email
        self.labelEmail = Label(self.entriesFrame, text="Email", font=("Times New Roman", 16, "bold"),  bg="#434242",
                                fg="#22a39f")
        ...
        # Student Gender
        self.labelGender = Label(self.entriesFrame, text="Gender", font=("Times New Roman", 16, "bold"),  bg="#434242",
                                 fg="#22a39f")
        ...
        # Student Address
        self.labelAddress = Label(self.entriesFrame, text="Address", font=("Times New Roman", 16, "bold"),  bg="#434242",
                                  fg="#22a39f")
    ...
    def instructorFrameButtons(self):
        ...
        self.btnReset = Button(self.buttonsFrame, command=self.resetForm, text="Reset Form", bd=0, cursor="hand2",
                               bg="#434242", fg="#22a39f", width=10, font=("Impact", 15))
