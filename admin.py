...
class AdminControls:
    ...
    def adminControlsFrame(self):
        ...
        self.entriesFrame = Frame(self.root, bg="#222222")
        self.entriesFrame.pack(side=TOP, fill=X)
        self.admin_frame_title = Label(self.entriesFrame, text="Admin Control Panel", font=("Times New Roman", 35),bg="#434242",fg="#22a39f")
        self.admin_frame_title.grid(row=0, columnspan=2, padx=10, pady=20, sticky="w")

        # Instructor Name
        self.labelName = Label(self.entriesFrame, text="Name", font=("Times New Roman", 16, "bold"), bg="#434242",fg="#22a39f")
        ...
        # Instructor Gender
        self.labelGender = Label(self.entriesFrame, text="Gender", font=("Times New Roman", 16, "bold"), bg="#434242",fg="#22a39f")
        self.labelGender.grid(row=1, column=2, padx=10, pady=5, sticky="w")
        self.comboGender = ttk.Combobox(self.entriesFrame, textvariable=self.insGender, font=("Times New Roman", 15), width=28,state="readonly")
        ...
        self.labelStyles = Label(self.entriesFrame, text="Dance Style", font=("Times New Roman", 16, "bold"),bg="#434242",fg="#22a39f")
        ...
        # Instructor Tel No
        self.labelTelNo = Label(self.entriesFrame, text="Contact Number", font=("Times New Roman", 16, "bold"),bg="#434242",fg="#22a39f")
        ...
        self.labelhrRate = Label(self.entriesFrame, text="Hourly Rate", font=("Times New Roman", 16, "bold"),bg="#434242",fg="#22a39f")
        ...
        self.labelAvail = Label(self.entriesFrame, text="Availability", font=("Times New Roman", 16, "bold"),bg="#434242",fg="#22a39f")
        ...
        self.labelListDays = Label(self.entriesFrame, text="Choose Available Days",font=("Times New Roman", 16, "bold"),bg="#434242",fg="#22a39f")
        ...
        # Instructor Username
        self.labelUsername = Label(self.entriesFrame, text="Username", font=("Times New Roman", 16, "bold"),bg="#434242",fg="#22a39f")
        ...
        # Instructor Password
        self.labelPassword = Label(self.entriesFrame, text="Password", font=("Times New Roman", 16, "bold"), bg="#434242",fg="#22a39f")
    ...
    def adminFrameButtons(self):
        ...
        self.buttonsFrame = Frame(self.entriesFrame, bg="#222222")
        ...
        self.btnAdd = Button(self.buttonsFrame, command=self.addInstructor, text="Add Instructor", bd=0, cursor="hand2",
                             bg="#434242",
                            fg="#22a39f", width=20, font=("Impact", 15))
        ...
        self.btnReset = Button(self.buttonsFrame, command=self.resetForm, text="Reset Form", bd=0, cursor="hand2",
                               bg="#434242",fg="#22a39f", width=20, font=("Impact", 15))
        ...
        self.btnLogOut = Button(self.entriesFrame, command=self.logOut, text="Log Out", bd=0, cursor="hand2",
                                bg="#434242",
                               fg="#22a39f", width=15, font=("Impact", 15))
    ...
    def tableOutputFrame(self):
        ...
        self.tableFrame = Frame(self.root, bg="#434242")
        ...
        self.style.configure("mystyle.Treeview", font=('Calibri', 12),
                             rowheight=50)
        self.style.configure("mystyle.Treeview.Heading", font=('Times New Roman', 14, "bold"), bg="#434242", sticky="w")
